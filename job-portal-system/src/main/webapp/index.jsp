...
try {
    ...
    while (rs.next()) {
        ...
        if (sqlTimestamp != null) {
            ...
            int nanos = (int) ((sqlTimestamp.getTime() % 1000) * 1000000); // Correct nanos calculation
        ...
        // Categorize jobs based on their category
...
<%! 
    // JSP Declaration for formatting protobuf Timestamp
...
<head>
  ...
  <title>JOBCRUITER - Find Your Dream Job</title>
...
<body>
  ...
  <section id="job-section" class="job-section">
...
<!-- Marketing jobs -->
  ...
  <script>
    // Basic category filtering - optional enhancement
